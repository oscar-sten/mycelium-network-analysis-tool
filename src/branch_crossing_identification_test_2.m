...
filter_sigma = 4;
D_T = 12; % Greater using quasi-Euclidean distance instead of city block
patch_range = [10 10];
...
test_image = 'o'; % Choose s or o.
% Note: adjust annotations of o
...
[candidate_pairs, removed_pairs] = find_possible_crossing_pairs(...
...
if ~isempty(faulty_crossings)
    plot(faulty_crossings(:, 1), faulty_crossings(:, 2), 'ko')
end
